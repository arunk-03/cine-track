          ...
          <ScrollReveal>
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 text-sm mb-6">
                ...
                <span className="text-gray-300">{show.Runtime}</span>
                <span className="text-gray-300">{show.Rated}</span>
                <span className="text-gray-300">{show.Year}</span>
                <span className="text-gray-300">{show.totalSeasons} Seasons</span>
              </div>
              ...
              <div className="grid lg:grid-cols-12 gap-8">
                ...
                >
                  <div className="sticky top-8">
                    <img 
                      src={show.Poster !== 'N/A' ? show.Poster : 'https://via.placeholder.com/300x450?text=No+Poster'} 
                      alt={show.Title} 
                ...
                >
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-300 leading-relaxed text-lg">{show.Plot}</p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <span className="ml-2 text-white">{show.Writer}</span>
                      </div>
                      <div>
                        <span className="text-gray-400">Cast:</span>
                        <span className="ml-2 text-white">{show.Actors}</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <span className="ml-2 text-white">{show.Released}</span>
                      </div>
                      <div>
                        <span className="text-gray-400">Seasons:</span>
                        <span className="ml-2 text-white">{show.totalSeasons}</span>
                      </div>
                      <div>
                        <span className="text-gray-400">Awards:</span>
                        <span className="ml-2 text-white">{show.Awards}</span>
                      </div>
                    </div>
                  </div>
